...
export default function Search(){
    ...
    const [searcBlock, setSearchBlock] = useState(false)
    ...
    return(
        ...
        {searcBlock && inputFocus && (
            <div className="absolute text-wrench-neutral-dark bg-wrench-neutral-white w-1/2 p-2 rounded-sm">
                <button onClick={redirect}className="p-1 my-1 min-w-full border border-wrench-neutral-dark hover:border-wrench-neutral-2 rounded-xl">
                    test
                </button>
                <button onClick={redirect}className="p-1 my-1 min-w-full border border-wrench-neutral-dark hover:border-wrench-neutral-2 rounded-xl">
                    test
